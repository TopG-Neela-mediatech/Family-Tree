...
namespace TMKOC.CountWithMe.Add
{
    ...
    {
        private AddSoundSO TestSoundSO;
        [SerializeField] private AddSoundSO USENGAudio;
        [SerializeField] private AddSoundSO HINDIAudio;
        [SerializeField] private AddSoundSO TAMILAudio;
        ...
        private void Start()
        {
            GameManagerAdd.Instance.OnLevelStart += () => playedIntro = false;
            GameManagerAdd.Instance.OnLevelStart += PlayLevelStartAudio;
            GameManagerAdd.Instance.OnLevelWin += PlayLevelCompleteAudio;
        }
        ...
        public void PlayLevelStartAudio()//commonsound
        {
            ...
            int currentLevelNumber = GameManagerAdd.Instance.LevelManager.GetCurrentLevelNumber();
