...
namespace TMKOC.CountWithMe.Sequence
{
    public class StarManager : MonoBehaviour
    {
        ...
        private void Start()
        {
           GameManagerSequence.Instance.OnLevelWin += () => EnableStar(GameManagerSequence.Instance.LevelManager.GetCurrentLevelNumber());
           GameManagerSequence.Instance.OnLevelStart += MoveStarsUp;
           GameManagerSequence.Instance.OnGameEnd += MoveStarsUp;
           GameManagerSequence.Instance.OnLevelLose += MoveStarsUp;
            DisableAllStars();
            SetStarsOnStart(GameManagerSequence.Instance.LevelManager.GetCurrentLevelNumber());
        }
